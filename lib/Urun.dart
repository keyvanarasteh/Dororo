...
class _UrunState extends State<Urun> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children:  
            [Column(
            children: [
              Urunn(a:0,s: s ,fiyat: s==0?Anahtar2[0] : s==1 ? Anahtar2[3] : s==2 ? Anahtar2[6]: s==3 ? Anahtar2[9]: s==4 ? Anahtar2[12]: Anahtar2[15], image: s==0?Anahtar1[0] : s==1 ? Anahtar1[3] : s==2 ? Anahtar1[6]: s==3 ? Anahtar1[9]: s==4 ? Anahtar1[12]: Anahtar1[15], miniaciklama: s==0?Anahtar3[0] : s==1 ? Anahtar3[3] : s==2 ? Anahtar3[6]: s==3 ? Anahtar3[9]: s==4 ? Anahtar3[12]: Anahtar3[15],rennk: renk,),
              Urunn(s:s,a:1,fiyat: s==0?Anahtar2[1] : s==1 ? Anahtar2[4] : s==2 ? Anahtar2[7]: s==3 ? Anahtar2[10]: s==4 ? Anahtar2[13]: Anahtar2[16], image: s==0?Anahtar1[1] : s==1 ? Anahtar1[4] : s==2 ? Anahtar1[7]: s==3 ? Anahtar1[10]: s==4 ? Anahtar1[13]: Anahtar1[16], miniaciklama: s==0?Anahtar3[1] : s==1 ? Anahtar3[4] : s==2 ? Anahtar3[7]: s==3 ? Anahtar3[10]: s==4 ? Anahtar3[13]: Anahtar3[16], rennk: renk,),
              Urunn(s:s,a:2,fiyat: s==0?Anahtar2[2] : s==1 ? Anahtar2[5] : s==2 ? Anahtar2[8]: s==3 ? Anahtar2[11]: s==4 ? Anahtar2[14]: Anahtar2[17], image: s==0?Anahtar1[2] : s==1 ? Anahtar1[5] : s==2 ? Anahtar1[8]: s==3 ? Anahtar1[11]: s==4 ? Anahtar1[14]: Anahtar1[17], miniaciklama: s==0?Anahtar3[2] : s==1 ? Anahtar3[5] : s==2 ? Anahtar3[8]: s==3 ? Anahtar3[11]: s==4 ? Anahtar3[14]: Anahtar3[17], rennk: renk,),
            ]
            ),
          ],
      ),
 ...
 class Urunn extends StatelessWidget{
   Urunn({required this.fiyat,required this.a,required this.image,required this.s, required this.miniaciklama, required this.rennk,}) ;
    ...
    return Padding(
      ...
      child: Container(
        padding: EdgeInsets.all(20),
            ...
            child: InkWell(
              onTap: () =>
                Navigator.push(context,MaterialPageRoute(builder: (context) => Detay(add: miniaciklama , fiyatt: fiyat, renkk: rennk , resimm: image),),),
